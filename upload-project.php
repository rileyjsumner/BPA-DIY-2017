                ...
                <form role="form" method="post">
                    ...
                    jQuery(document).ready(function($){
                        $('.my-form .add-box').click(function(){
                            ...
                            var box_html = $('<p class="text-box"><input type="text" name="materials" value="" id="materials' + n + '" /></p><p class="text-box"> <input type="text" name="url' + n + '" value="" id="url' + n + '" /> <a href="#" class="remove-box">Remove</a></p>');
                            box_html.hide();
